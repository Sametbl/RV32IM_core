...
#                       SW      x2,  0(x1)                                                                                                                                                                                                                                                                                                                                                                              
#                       ADDI    x4,  x0, 0x100            # A at 0x100                                                                                                                                                                                                                                                                                                                                                                  
#                       ADDI    x20, x0, 1                # Result initally = 1                                                                                                                                                                                                                                                                                                                                                                 
#                       SW      x20, 4(x4)                                                                                                                                                                                                                                                                                                                                                                  
#
#        MAIN_LOOP:     ADDI    x4, x0, 0x100       # A at 0x100                                                                                                                                                                                                                                                                                                                                                                 
#                       ADDI    x1, x0, 0x400                                                                                                                                                                                                                                                                                                                                                                   
...
#                       BNE     x8, x0, FACTORIAL_1                                                                                                                                                                                                                                                                                                                                                                  
#                       LW      x20, 4(x4)          # Load Result from 0x104                                                                                                            
#                       ADDI    x19, x0, 0          # Signed disabled                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
#                       JAL     x0, BCD_CONV_R20                                                                                                                                                                                                                                                                                                                                                                    
#                                                                                                                                                                                                                                                                                                                                                                   
#        FACTORIAL_1:   ADDI    x4,  x0, 0x100      # A at 0x100                                                                                                            
#                       ADDI    x20, x0, 1                                                                                                          
#                       LW      x9,  0(x4)          # x9  = operand A                                                                                                               
#                       BNE     x9,  x0, FACTORIAL_2                                                                                                            
#                       SW      x20, 4(x4)          # 0! = 1                                                                                                            
#                       ADDI    x19, x0, 0          # Signed disabled                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
#                       JAL     x0, BCD_CONV_R20                                                                                                                                                                                                                                                                                                                                                                    
#
#        FACTORIAL_2:   MUL     x20, x20, x9        #                                                                                                           
#                       ADDI    x9,  x9,  -1                                                                                                                
#                       BNE     x9, x0, FACTORIAL_2                                                                                                                                                                                                                                                                                                                                                           
#                       SW      x20, 4(x4)          # Store Result to 0x104                                                                                                         
#                       ADDI    x19, x0, 0          # Signed disabled                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
#                       JAL     x0, BCD_CONV_R20                                                                                                                                                                                                                                                                                                                                                                       
#                                                                                                                   
