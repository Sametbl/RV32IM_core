...
#                        BNE     x8, x0, DO_FRACT_1                                          
#                        LW      x20, 8(x4)          # Store Result to 0x108                 
#                        ADDI    x19, x0, 1          # Signed enable                         
#                        JAL     x0, BCD_CONV_R20                                            
#                                                                                            
#         DO_FRACT_1:    ADDI    x4, x0, 0x100       # A at 0x100, B at 0x104          
...
#                        BEQ     x11, x0, ABS_B                                              
#                        SUB     x9,  x0, x9                                                  
#         ABS_B:         BEQ     x12, x0, DO_FRACT_2                                         
#                        SUB     x10, x0, x10                                                
#                                                                                            
#         DO_FRACT_2:    LI      x8,  1000000    # Scale = 1_000_000                     
#                        DIVU    x15, x9, x10        # A / B                                 
#                        MUL     x15, x15, x8        # 1000000*(A / B)                       
#                        REMU    x16, x9, x10        # A % B                                 
#                        MUL     x16, x16, x8        # 1000000*(A % B)                       
#                        DIVU    x16, x16, x10                                               
#                        ADD     x20, x15, x16                                               
#                        BEQ     x13, x0, SHOW_RESULT                                        
#                        SUB     x20, x0, x20                                                
#                                                                                            
